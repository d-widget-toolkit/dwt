...
extern (C) void * function(const scope char *)gdk_atom_intern_static_string;
extern (C) void * function(const scope char *, gint)gdk_atom_intern;
...
extern (C) _GdkDrawable * function(_GdkDrawable *, const scope char *, gint, gint)gdk_bitmap_create_from_data;
...
extern (C) void function(_GdkGC *, gint, const scope char *, gint)gdk_gc_set_dashes;
...
extern (C) gint function(void *, char * *, gsize *, const scope char *, char * *, char * *, _GError * *)gdk_pixbuf_save_to_bufferv;
extern (C) gint function(void *, char * *, gsize *, const scope char *, _GError * *, ...)gdk_pixbuf_save_to_buffer;
...
extern (C) void * gdk_atom_intern_static_string(const scope char *);
extern (C) void * gdk_atom_intern(const scope char *, gint);
...
extern (C) _GdkDrawable * gdk_bitmap_create_from_data(_GdkDrawable *, const scope char *, gint, gint);
...
extern (C) void gdk_gc_set_dashes(_GdkGC *, gint, const scope char *, gint);
...
extern (C) gint gdk_pixbuf_save_to_bufferv(void *, char * *, gsize *, const scope char *, char * *, char * *, _GError * *);
extern (C) gint gdk_pixbuf_save_to_buffer(void *, char * *, gsize *, const scope char *, _GError * *, ...);
