...
extern (C) gulong function(void *, const scope char *, _BCD_func__2331, void *, gint)g_signal_connect_object;
...
extern (C) void function(_GObject *, const scope char *, void *)g_object_set_data;
extern (C) void * function(_GObject *, const scope char *)g_object_get_data;
...
extern (C) void function(void *, const scope char *, ...)g_object_get;
extern (C) void function(void *, const scope char *, ...)g_object_set;
...
extern (C) gulong function(void *, const scope char *, _BCD_func__2331, void *, _BCD_func__2330, gint)g_signal_connect_data;
extern (C) gulong function(void *, const scope char *, _GClosure *, gint)g_signal_connect_closure;
...
extern (C) void function(void *, const scope char *)g_signal_stop_emission_by_name;
...
extern (C) gint function(const scope char *, GType, guint *, GQuark *, gint)g_signal_parse_name;
...
extern (C) guint function(const scope char *, GType)g_signal_lookup;
extern (C) void function(void *, const scope char *, ...)g_signal_emit_by_name;
extern (C) void function(void *, guint, GQuark, ...)g_signal_emit;
extern (C) void function(void *, guint, GQuark, const scope char *)g_signal_emit_valist;
extern (C) void function(_GValue *, guint, GQuark, _GValue *)g_signal_emitv;
extern (C) guint function(const scope char *, GType, gint, guint, _BCD_func__2309, void *, _BCD_func__2311, GType, guint, ...)g_signal_new;
extern (C) guint function(const scope char *, GType, gint, _GClosure *, _BCD_func__2309, void *, _BCD_func__2311, GType, guint, char *)g_signal_new_valist;
extern (C) guint function(const scope char *, GType, gint, _GClosure *, _BCD_func__2309, void *, _BCD_func__2311, GType, guint, GType *)g_signal_newv;
...
extern (C) GType function(GType, const scope char *, _GTypeInfo *, gint)g_type_register_static;
...
extern (C) GType function(const scope char *)g_type_from_name;
...
extern (C) char * function(const scope char *, gssize, gsize *, gsize *, _GError * *)g_filename_from_utf8;
...
extern (C) GQuark function(const scope char *)g_quark_from_string;
extern (C) GQuark function(const scope char *)g_quark_from_static_string;
extern (C) GQuark function(const scope char *)g_quark_try_string;
...
extern (C) void g_object_set_data(_GObject *, const scope char *, void *);
extern (C) void * g_object_get_data(_GObject *, const scope char *);
...
extern (C) void g_object_get(void *, const scope char *, ...);
extern (C) void g_object_set(void *, const scope char *, ...);
...
extern (C) gulong g_signal_connect_data(void *, const scope char *, _BCD_func__2331, void *, _BCD_func__2330, gint);
extern (C) gulong g_signal_connect_closure(void *, const scope char *, _GClosure *, gint);
...
extern (C) void g_signal_stop_emission_by_name(void *, const scope char *);
extern (C) void g_signal_stop_emission(void *, guint, GQuark);
extern (C) _GSignalInvocationHint * g_signal_get_invocation_hint(void *);
extern (C) gint g_signal_parse_name(const scope char *, GType, guint *, GQuark *, gint);
...
extern (C) guint g_signal_lookup(const scope char *, GType);
extern (C) void g_signal_emit_by_name(void *, const scope char *, ...);
...
extern (C) guint g_signal_new(const scope char *, GType, gint, guint, _BCD_func__2309, void *, _BCD_func__2311, GType, guint, ...);
extern (C) guint g_signal_new_valist(const scope char *, GType, gint, _GClosure *, _BCD_func__2309, void *, _BCD_func__2311, GType, guint, char *);
...
extern (C) GType g_type_register_static(GType, const scope char *, _GTypeInfo *, gint);
...
extern (C) GType g_type_from_name(const scope char *);
...
extern (C) char * g_filename_from_utf8(const scope char *, gssize, gsize *, gsize *, _GError * *);
...
extern (C) void g_free(const scope void *);
...
extern (C) GQuark g_quark_from_string(const scope char *);
extern (C) GQuark g_quark_from_static_string(const scope char *);
extern (C) GQuark g_quark_try_string(const scope char *);
